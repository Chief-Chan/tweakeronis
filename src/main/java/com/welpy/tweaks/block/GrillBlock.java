...
public class GrillBlock extends WTweaksModElements.ModElement {
	@ObjectHolder("w_tweaks:grill")
	public static final Block block = null;
	@ObjectHolder("w_tweaks:grill")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public GrillBlock(WTweaksModElements instance) {
		super(instance, 1);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("grill"));
		}
	}
	@Override
	@OnlyIn(Dist.CLIENT)
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ANVIL).sound(SoundType.METAL).hardnessAndResistance(1f, 10f).setLightLevel(s -> 10).harvestLevel(1)
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("grill");
		}
