...
public class ChilliBlock extends WTweaksModElements.ModElement {
	@ObjectHolder("w_tweaks:chilli_plant")
	public static final Block block = null;
	public ChilliBlock(WTweaksModElements instance) {
		super(instance, 9);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("chilli_plant"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("w_tweaks:chilli_plant"), configuredFeature);
		}
	}
	@SubscribeEvent
